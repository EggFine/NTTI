...
export const MODELS = [
  { id: 'self', name: '自我模型', dimensions: ['S1', 'S2', 'S3'] as DimensionId[] },
  { id: 'emotion', name: '情感模型', dimensions: ['E1', 'E2', 'E3'] as DimensionId[] },
  { id: 'attitude', name: '态度模型', dimensions: ['A1', 'A2', 'A3'] as DimensionId[] },
  { id: 'action', name: '行动驱力模型', dimensions: ['Ac1', 'Ac2', 'Ac3'] as DimensionId[] },
  { id: 'social', name: '社交模型', dimensions: ['So1', 'So2', 'So3'] as DimensionId[] },
];

export const DIMENSIONS: DimensionInfo[] = [
  {
    id: 'S1', name: 'S1 自尊自信', model: '自我模型',
    levels: {
  ...
  {
    id: 'S2', name: 'S2 自我清晰度', model: '自我模型',
    levels: {
  ...
  {
    id: 'E1', name: 'E1 依恋安全感', model: '情感模型',
    levels: {
  ...
  {
    id: 'E2', name: 'E2 情感投入度', model: '情感模型',
    levels: {
  ...
  {
    id: 'E3', name: 'E3 边界与依赖', model: '情感模型',
    levels: {
  ...
  {
    id: 'A1', name: 'A1 世界观倾向', model: '态度模型',
    levels: {
      L: '看世界自带防御滤镜，先怀疑，再靠近。',
  ...
  {
    id: 'A2', name: 'A2 规则与灵活度', model: '态度模型',
    levels: {
  ...
  {
    id: 'A3', name: 'A3 人生意义感', model: '态度模型',
    levels: {
  ...
  {
    id: 'Ac1', name: 'Ac1 动机导向', model: '行动驱力模型',
    levels: {
  ...
  {
    id: 'Ac2', name: 'Ac2 决策风格', model: '行动驱力模型',
    levels: {
  ...
  {
    id: 'Ac3', name: 'Ac3 执行模式', model: '行动驱力模型',
    levels: {
  ...
  {
    id: 'So1', name: 'So1 社交主动性', model: '社交模型',
    levels: {
  ...
  {
    id: 'So2', name: 'So2 人际边界感', model: '社交模型',
    levels: {
  ...
  {
    id: 'So3', name: 'So3 表达与真实度', model: '社交模型',
    levels: {
      L: '表达更直接，心里有啥基本不爱绕。',
