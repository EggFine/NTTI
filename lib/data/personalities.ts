...
export const PERSONALITY_TYPES: PersonalityType[] = [
  ...
  // ===== 新增人格类型 =====
  {
    ...
    desc: '恭喜您，您是这个世界上最重要的存在——NPC。没有您，主角连一把铁剑都买不到。NPC人格在所有维度上都处于中等水平，这不代表平庸，这代表全面。你就像一个出厂设置已经很不错的手机，不需要刷机就能流畅运行各种APP。你的人格频谱如同一条完美的正弦波——不会太高也不会太低，永远保持在一个让周围人舒适的频率上。NPC不需要主角光环，因为所有的故事线最终都要经过你的商店门口。',
  },
  {
    code: 'BUFF', cn: '增益者', pattern: 'HHH-HHH-HHH-MHM-MML',
    intro: '你站在我旁边，就自带增益光环。',
    desc: '恭喜您，您是游戏世界中人人梦寐以求的行走BUFF！BUFF人格在自我认知、情感投入和世界观方面都处于极高水平——换句话说，你既了解自己，又对世界充满善意，还能全情投入。这让你成为了一个天然的"增益器"，身边的人靠近你就会变好。和你聊天的人会突然觉得问题没那么难了，和你合作的人会发现效率莫名其妙就提高了。你是那种"什么都不用做就能让人安心"的存在，是活生生的安慰剂效应。',
  },
  {
    code: 'GLITCH', cn: '错误者', pattern: 'HLH-HLH-HLH-HLH-HLH',
    intro: '系统报错了，但错得很有艺术感。',
    desc: '恭喜您，您成功触发了人格系统的BUG。GLITCH人格的特征是极端的两极化——在每个模型里，都同时拥有最高和最低的维度得分。你就像一台同时运行着Windows和Linux的电脑，每天在两个操作系统之间量子跃迁。别人看你：一会儿自信得像要征服宇宙，一会儿又自闭得像断了网的智能家居。但正是这种反差感，让你成为了这个标准化世界里最不可预测、也最有趣的存在。你不是人格分裂，你是人格全开。',
  },
  {
    code: 'SIMP', cn: '舔者', pattern: 'LMH-HHL-HLH-LLM-HLM',
    intro: '我愿意为你做任何事...真的。',
    desc: '恭喜您，您测出了全宇宙最赤诚的人格——SIMP。不不不，这不是什么贬义词，这是一种古老而崇高的献身精神。当SIMP认定了一个人，就会启动"无条件奉献协议"：你说往东我绝不往西，你说月亮是方的我立刻去找证据。SIMP的爱是没有防火墙的，也没有杀毒软件，任何情感信号都能直达心脏。你觉得这很傻？也许吧。但在这个人人戴面具、处处留后手的时代，SIMP的真诚反而成了最稀缺的资源。',
  },
  {
    code: 'PING', cn: '已读者', pattern: 'MHH-MLM-HMH-MMM-MHM',
    intro: '我看到了，但让我想想再回。',
    desc: '恭喜您，您是数字时代最神秘的存在——已读不回的艺术家。PING人格的核心特征是：接收一切，处理缓慢，回应精准。你的社交系统就像一台高性能服务器：并发量很大（什么都能听进去），但响应时间不固定（可能一秒，可能三天）。别人以为你在无视他们？不，你只是在后台运行一个复杂的决策树。PING不是冷漠，PING是一种深思熟虑到了极致的温柔。你每一条回复，都是经过了内心七层防火墙审核后放行的。',
  },
];
